...
*/
  ...
  function La(a, b, c) {
    ...
    a = S(a, d, T(d));
    b =
      null != b.g[3] && 0 != p(b, 3).length ? (3 == c ? ';ext=' + p(b, 3) : null != a.g[13] ? p(a, 13) + w(b, 3) : ' ext. ' + w(b, 3)) : '';
    a: {
  ...
  function Ra(a, b, c, d) {
    ...
    if (0 <= g) {
      ...
      (g = e.g),
        (f = b.search(za)),
        0 <= f ? ((f = b.substring(f)), (f = f.replace(Ba, '')), (h = f.search(Aa)), 0 <= h && (f = f.substring(0, h))) : (f = ''),
        g.call(e, f);
    g = e.toString();
    f = g.indexOf(';isub=');
    ...
    0 != h
      ? ((e = T(h)), e != c && (f = S(a, h, e)))
      : (Ja(e), b.g(e.toString()), null != c ? ((h = w(f, 10)), q(g, 1, h)) : d && (delete g.g[6], g.i && delete g.i[6]));
